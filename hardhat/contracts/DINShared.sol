...
error TC_NotReadyToSlashValidators(); // "Task Coordinator: Not ready to slash validators"
...
error TC_FailedToFinalizeEvaluation(); // "Task Coordinator: Failed to finalize evaluation"
